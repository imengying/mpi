...
pub enum Color {
    ...
    DiffAddedText,
    DiffRemovedText,
    /// The working label. Warmer than the hint grey, which disappeared into the
    /// background at the one place a reader looks for reassurance that the turn is live.
    Blue, // #89b4fa
}
